...
console.log("👤 Usuario actual:", config.obtenerUsuario());
...
if (!config.obtenerUsuario()) {
  ...
  if (nombre) {
    ...
    console.log("✅ Usuario guardado:", config.obtenerUsuario());
  }
}
const usuarioInfo = document.getElementById('usuario-info');
if (usuarioInfo) {
  usuarioInfo.textContent = `👤 Usuario actual: ${config.obtenerUsuario()}`;
}
